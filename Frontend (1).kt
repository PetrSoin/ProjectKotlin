                ...
                document.addEventListener("DOMContentLoaded", function () {
                    ...
                    document.addEventListener("drop", function (e) {
                        ...
                        if (newStatus) {
                            ...
                            draggedCard.classList.remove("yellow", "green");
                            draggedCard.classList.add(statusToColorClass(newStatus));

                            if (currentDetailsCard === draggedCard) {
                                setStatusRadio(newStatus);
                                setDetailsColorFromCard(draggedCard);
                            }
                        }
                    });
